...
export default class CauHoi extends React.Component {
  constructor(props){
    super(props);
  ...
  componentDidMount(){
    return fetch('http://192.168.3.166:82/TracNghiem/CauHoi1.php')
    ...
    return (
      ...
      <View style={{ flex: 1, margin:20 }}>
       <Text style={{ marginBottom: 20, textAlign: 'center', backgroundColor: 'green', fontSize: 20, color: "white" }}>CÂU HỎI TRẮC NGHIỆM</Text>
        <Text style={{ marginBottom: 20 }}>CÂU HỎI 1:</Text>  
        ...
        <Text style = {styles.text}>A: 2,5</Text>
                </TouchableOpacity>
        <TouchableOpacity style={styles.cauhoi2} onPress={() => this.resultFalse()}>
        <Text style = {styles.text}>B: 1</Text>
                </TouchableOpacity>
        </View>
        <Button
          title="Tiếp"
          color="grey"
          onPress={() => this.props.navigation.navigate('CauHoi2')}
        /> 
        <Button
          title="Đáp Án"
          color="red"
