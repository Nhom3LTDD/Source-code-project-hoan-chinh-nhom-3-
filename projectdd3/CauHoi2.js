...
export default class CauHoi2 extends React.Component {
  constructor(props){
    super(props);
  ...
  componentDidMount(){
    return fetch('http://192.168.3.166:82/TracNghiem/CauHoi2.php')
  ...
  render() {
    ...
    return (
      ...
      <Text style={{ marginBottom: 20, textAlign: 'center', backgroundColor: 'green', fontSize: 20, color: "white" }}>CÂU HỎI TRẮC NGHIỆM</Text>
       <Text style={{ marginBottom: 20 }}>CÂU HỎI 2:</Text>  
       <Text style={{ marginBottom: 20 }}>Hãy chọn câu trả lời chính xác:</Text>  
        ...
        <Text style = {styles.text}>A: 2</Text>
                </TouchableOpacity>
        <TouchableOpacity style={styles.cauhoi2} onPress={() => this.resultTrue()}>
        <Text style = {styles.text}>B: 6</Text>
                </TouchableOpacity>
        </View>
        ...
        <Button
          title="Quay lại"
          color="yellow"
          onPress={() => this.props.navigation.navigate('CauHoi')}
        />
